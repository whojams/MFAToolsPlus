...
public partial class VersionUpdateSettingsUserControlModel : ViewModelBase
{
    ...
    public ObservableCollection<LocalizationBlock> DownloadSourceList =>
    [
        new()
        {
            Name = "GitHub"
    ...
    public ObservableCollection<LocalizationBlock> UIUpdateChannelList =>
    [
    ...
    public ObservableCollection<LocalizationBlock> ResourceUpdateChannelList =>
    [
        new(LangKeys.AlphaVersion),
        new(LangKeys.BetaVersion),
        new(LangKeys.StableVersion),
    ...
    public ObservableCollection<LocalizationBlock> ProxyTypeList =>
    [
        new("HTTP Proxy")
        {
