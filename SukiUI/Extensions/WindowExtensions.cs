...
public static class WindowExtensions
{
    extension(Window window)
    {
        ...
        public void CenterOnScreen(Screen? screen)
        {
        ...
        public void ConstrainMaxSizeToScreenRatio(double maxWidthScreenRatio, double maxHeightScreenRatio)
        {
            Screen? screen = null;
